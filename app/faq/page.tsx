...
export default function FAQ() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "يمكن الضغط على زر طلب معروض و اختيار نوع المعروض ثم نوع الخدمة و سوف يظهر لك التجميع النهائي تحت و تسعدنا خدمتك ."
    },
    {
    ...
    },
    {
      ...
      answer: "نقبل جميع طرق الدفع المتاحة، بما في ذلك التحويل البنكي، والدفع الإلكتروني. يمكنك اختيار الطريقة الأنسب لك."
    }
  ];

                ...
                <div className="space-y-6 text-gray-900 leading-relaxed text-right">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">لا نتابع الخطابات المرسلة من طرفنا دورنا هو كتابة الخطاب و ارساله في حال طلب العميل ارساله ومن ثم تزويد العميل برقم الارسالية وهو يتابعها مع الجهة المرسلة عليها</p>
                    </div>

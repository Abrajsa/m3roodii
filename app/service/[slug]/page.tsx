            ...
            <div className="prose prose-lg max-w-none">
              {descriptionLines.map((line, index) => {
                ...
                if (line.startsWith('✔️') || line.match(/^[✔✓]/)) {
                  return (
                    <p key={index} className="text-gray-700 mb-3 text-base sm:text-lg leading-relaxed flex items-start">
                ...
                if (line.match(/^[ا-ي].*[؟?]$/) || line.includes('؟')) {
                  return (
                    <h3 key={index} className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 mt-6 first:mt-0">
                      {line}
                    </h3>
                  );
                }
                ...
                if (line.trim().length > 0) {
                  return (
                    <p key={index} className="text-gray-700 mb-4 text-base sm:text-lg leading-relaxed">
                      {line}
                    </p>
                  );
                }
